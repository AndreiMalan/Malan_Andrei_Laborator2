...
namespace Malan_Andrei_Laborator2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Malan_Andrei_Laborator2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Malan_Andrei_Laborator2Context context,
